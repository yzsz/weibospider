...
app.conf.update(
    ...
    CELERYBEAT_SCHEDULE={
        ...
        'home_newest_task': {
            'task': 'tasks.home.excute_home_newest_task',
    ...
    CELERY_QUEUES=(
        ...
        Queue('ajax_home_newest_crawler', exchange=Exchange('ajax_home_newest_crawler', type='direct'), routing_key='ajax_home_newest_info'),
